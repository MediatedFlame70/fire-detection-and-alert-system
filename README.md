# CN2VF-Net: Fire and Smoke Detection

PyTorch implementation of CN2VF-Net (Convolutional Neural Network and Vision Transformer Framework) for fire and smoke detection in high-altitude drone imagery.
...
- **Output**: 
  - Classification: Fire/Smoke/Neutral (3 classes)
  - Bounding Box: Normalized [x, y, w, h] coordinates
- **Parameters**: ~1.26M (lightweight for drone deployment)
